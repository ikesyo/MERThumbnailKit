...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self.thumbnailManager addThumbnailOperationForURL:url size:CGSizeMake(self.tableView.rowHeight, self.tableView.rowHeight) page:0 time:0 completion:^(NSURL *url, UIImage *image,METhumbnailManagerCacheType cacheType) {
